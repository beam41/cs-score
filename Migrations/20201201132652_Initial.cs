        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupProjectRef = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Score_User_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Score_Project_ToProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Score_FromUserId",
                table: "Score",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Score_ToProjectId",
                table: "Score",
                column: "ToProjectId");
